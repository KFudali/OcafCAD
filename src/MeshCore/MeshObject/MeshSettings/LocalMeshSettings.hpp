...
public:
    ...
    void addEdgeSizing(const SubShapeId& id, float min, float max) {
    ...
    void addFaceSizing(const SubShapeId& id, float min, float max) {
    ...
    void addVolumeSizing(const SubShapeId& id, float min, float max) {
