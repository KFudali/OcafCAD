...
TEST_F(DocLabelUtilsTest, testIsRootAssemblyLabel) {
    ...
    ASSERT_FALSE(DocLabelUtils::canBePrototypeLabel(label));
    ASSERT_FALSE(DocLabelUtils::canBePartLabel(label));
}
...
TEST_F(DocLabelUtilsTest, testIsPrototypeLabel) {
    ...
    ASSERT_TRUE(DocLabelUtils::canBePrototypeLabel(label));
    ASSERT_FALSE(DocLabelUtils::canBePartLabel(label));
}
...
TEST_F(DocLabelUtilsTest, testIsPartLabel) {
    ...
    EXPECT_FALSE(DocLabelUtils::isRootAssemblyLabel(label));
    ASSERT_FALSE(DocLabelUtils::canBePrototypeLabel(label));
    ASSERT_TRUE(DocLabelUtils::canBePartLabel(label));
}